...
//char			*vconf = "";
//#endif
char                    *vconf = "v4l2src device=/dev/video1 use-fixed-fps=false ! ffmpegcolorspace ! capsfilter caps=video/x-raw-rgb,bpp=24,width=800,height=600 ! identity name=artoolkit ! fakesink";
